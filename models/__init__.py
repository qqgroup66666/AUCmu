...
from .resnet_balancedsoftmax import _resnet18, _resnet50
...
def generate_net(args, _cls_num_list):
    ...
    if model_use == "feature_exactor": # 只需要特征提取器
        if args.model_type in ["_resnet18", "resnet18", "resnet34", "_resnet32", "resnet50"]:
        ...
        if args.model_type in ["_resnet18", "resnet18", "resnet34", "_resnet32", "resnet50", "_resnet50", "resnext50", "resnext50_norm"]:
