...
def _resnet18(num_classes, use_fc=False, pretrain=False, dropout=None, stage1_weights=False, dataset=None, log_dir=None,
                 test=False, *args):
    print('Loading ResNet 18 Feature Model.')
    encoder = ResNet_Cifar(BasicBlock, [3, 3, 3])
